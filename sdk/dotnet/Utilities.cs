...
namespace ediri.Port
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/dirien/pulumi-port-labs";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("ediri.Port.version.txt");
    ...
    internal sealed class PortResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PortResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
